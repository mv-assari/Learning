...
namespace Claculator_Delegate
{
    internal class Program
    {
        //Project-2
        public delegate double CalculatorDelegate(int a, int b);
        ...
        public static void RunMethod(CalculatorDelegate action,int a,int b)
        {
