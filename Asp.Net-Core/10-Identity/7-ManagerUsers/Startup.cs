...
namespace RunIdentity
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<User,Role>().AddEntityFrameworkStores<DataBaseContext>().AddDefaultTokenProviders(); // برای اینکه سرویس ها ایدنتیتی برای ما فعال بشه باید اینکارو انجام بدیم
        }
